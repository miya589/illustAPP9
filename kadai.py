...
model3 = torch.hub.load("bryandlee/animegan2-pytorch:main", "generator", pretrained="face_paint_512_v1")
...
select_model = st.sidebar.selectbox('モデル選択:',['face_paint_512_v2', 'celeba_distill','face_paint_512_v1','paprika'])
...
if upload_img is not None:
    ...
    elif select_model == 'face_paint_512_v1':
      output_img = face2paint(model3, tg_img, size=512)
    elif select_model == 'paprika':
      output_img = face2paint(model4, tg_img, size=512)
